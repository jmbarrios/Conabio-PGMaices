  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(
        ...
        br(),
        h4(
          "La gran adaptabilidad del ", strong("maíz"), " a diferentes ",
      ...
      tabItem(
        ...
        h4(
          "La distribución de las razas de maíces se encuentran en todo México.
           De izquierda a derecha se muestran los distintos ",
          tags$a(
            href = "https://www.biodiversidad.gob.mx/diversidad/alimentos/maices/razas-de-maiz",
            "complejos raciales"
          ),
      ...
      tabItem(
        ...
        br(),
        h3(
          strong("Bases de datos generadas durante la ejecución del", tags$a(
            href = "https://www.biodiversidad.gob.mx/diversidad/proyectoMaices",
      ...
      tabItem(
        ...
        fluidRow(
          userBox(
            ...
            footer = socialButton(
              href = "https://github.com/APonce73",
              icon = icon("github")
            ),
            tags$a(href = "http://www.conabio.gob.mx/web/conocenos/CGAyRB_CPAM.html", "Conabio")
          )
