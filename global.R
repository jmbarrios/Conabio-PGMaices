...
TableL <- TableL %>%
  # Conicos
  dplyr::mutate(RatingCol = revalue(RatingCol, c(
    "Arrocillo Amarillo" = "#00441b", "Cacahuacintle" = "#006d2c",
  ...
  # Chapalotes
  dplyr::mutate(RatingCol = revalue(RatingCol, c(
    "Chapalote" = "#0868ac", "Dulcillo del Noroeste" = "#2b8cde",
    "Elotero de Sinaloa" = "#4eb3d3", "Reventador" = "#7bccc4"
  ))) %>%
  # Tropicales precoces
  dplyr::mutate(RatingCol = revalue(RatingCol, c(
    "Conejo" = "#4d004b", "Nal-tel" = "#810f7c", "Ratón" = "#88419d",
    "Zapalote Chico" = "#8c6bb1"
  ))) %>%
  # Ocho hileras
  dplyr::mutate(RatingCol = revalue(RatingCol, c(
    "Ancho" = "#7f0000", "Blando" = "#b30000", "Bofo" = "#d7301f",
  ...
  # Sierra de Chihuahua
  dplyr::mutate(RatingCol = revalue(RatingCol, c(
    "Apachito" = "#67001f", "Azul" = "#980043", "Serrano de Jalisco" = "#ce1256",
    "Cristalino de Chihuahua" = "#e7298a", "Gordo" = "#df65b0", "Mountain Yellow" = "#c994c7"
  ))) %>%
  # Maduración tardía
  dplyr::mutate(RatingCol = revalue(RatingCol, c(
    "Comiteco" = "#081d58", "Coscomatepec" = "#253494", "Dzit Bacal" = "#225ea8", "Mixeño" = "#1d91c0",
  ...
  # Dentados Tropicales
  dplyr::mutate(RatingCol = revalue(RatingCol, c(
    "Celaya" = "#67000d", "Chiquito" = "#a50f15", "Choapaneco" = "#cb181d",
